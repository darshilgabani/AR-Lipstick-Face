...
open class ContourGraphicOverlay(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    abstract class Graphic(private val overlay: ContourGraphicOverlay) {
