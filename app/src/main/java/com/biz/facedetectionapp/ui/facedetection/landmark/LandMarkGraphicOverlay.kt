...
open class LandMarkGraphicOverlay(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    abstract class Graphic(private val overlay: LandMarkGraphicOverlay) {
