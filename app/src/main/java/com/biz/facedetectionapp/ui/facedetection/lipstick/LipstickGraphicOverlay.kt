...
open class LipstickGraphicOverlay(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    abstract class Graphic(private val overlay: LipstickGraphicOverlay) {
